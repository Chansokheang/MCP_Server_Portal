...
const I18N = (() => {
  ...
  Object.assign(dict, {
    ...
    "Changed here": "여기서 변경됨", "From the backend": "백엔드에서 상속", "This gateway only": "이 게이트웨이만", "Use the backend's": "백엔드 값 사용", "Save values": "값 저장", "Add a value for this gateway": "이 게이트웨이용 값 추가", "the value": "값",
